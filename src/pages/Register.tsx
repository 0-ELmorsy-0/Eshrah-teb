    ...
    >
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-6">
          <select name="gender" value={formData.gender} onChange={handleChange} required className="w-full bg-transparent border-b border-gray-300 dark:border-slate-700 py-3 text-slate-900 dark:text-white focus:border-burgundy-500 dark:focus:border-burgundy-400 outline-none transition-colors cursor-pointer appearance-none [&>option]:bg-white dark:[&>option]:bg-slate-800">
          ...
          <select name="howDidYouKnow" value={formData.howDidYouKnow} onChange={handleChange} required className="w-full bg-transparent border-b border-gray-300 dark:border-slate-700 py-3 text-slate-900 dark:text-white focus:border-burgundy-500 dark:focus:border-burgundy-400 outline-none transition-colors cursor-pointer appearance-none [&>option]:bg-white dark:[&>option]:bg-slate-800">
             <option value="" disabled>{t('howDidYouKnowGhaith')}</option>
        ...
        <button disabled={loading} type="submit" className="w-full md:w-auto md:min-w-[200px] mx-auto block bg-burgundy-500 hover:bg-burgundy-400 text-white font-bold py-3.5 px-8 rounded-xl shadow-lg shadow-burgundy-500/20 mt-10 transition-all hover:-translate-y-0.5 disabled:opacity-50">
